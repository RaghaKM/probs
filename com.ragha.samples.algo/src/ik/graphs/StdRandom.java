...
public final class StdRandom {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            System.out.println("%2d "+ " -- "+uniform(100));
            System.out.println("%8.5f "+ " -- "+ uniform(10.0, 99.0));
            System.out.println("%5b "+ " -- "+   bernoulli(0.5));
            System.out.println("%7.5f "+ " -- "+ gaussian(9.0, 0.2));
            System.out.println("%1d "+ " -- "+  discrete(probabilities));
            System.out.println("%1d "+ " -- "+   discrete(frequencies));
            StdRandom.shuffle(a);
            for (String s : a)
